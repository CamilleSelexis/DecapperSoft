...
bool currentMotorPositionRPC(long ZPosRPC, long MPosRPC, long CPosRPC, long ZTargetRPC, long MTargetRPC, long CTargetRPC, long ZPosEncRPC, long MPosEncRPC, long CPosEncRPC){
  ZPos = ZPosRPC;
  MPos = MPosRPC;
  CPos = CPosRPC;
  ZTarget = ZTargetRPC;
